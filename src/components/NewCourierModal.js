          ...
          <TabPanel value={value} index={1}>
            ...
            >
              {({
                ...
                <form onSubmit={handleSubmit}>
                  <Typography sx={{ backgroundColor: 'yellow',fontStyle: 'italic' }}>
                    Package Details
                  </Typography>
                  <Box
                    display='grid'
                  ...
                  <Typography sx={{ backgroundColor: 'pink', fontStyle: 'italic' }} mt={2}>
                    Receiver's Details
                  </Typography>
                  <Box
                    display='grid'
                  ...
                  <Typography sx={{ backgroundColor: '#F08080', fontStyle: 'italic'} } mt={2}>
                    Sender's Details
                  </Typography>
                  <Box
                    display='grid'
